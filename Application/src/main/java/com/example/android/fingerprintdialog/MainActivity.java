...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String $prince =  telephonyManager.getDeviceId();
        Log.d("device_id", $prince);
        if(!$prince.equals("861111032472089")){
            this.finish();
            System.exit(0);
        }
        try {
...
//            v.setVisibility(View.VISIBLE);
            v.setVisibility(View.INVISIBLE); // added to hide encrypted message
